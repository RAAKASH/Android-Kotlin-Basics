...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        val textRes =  when(lemonadeState){
        ...
        textAction.setText(textRes)
        if(lemonadeState==SQUEEZE){
            getResources().getString(R.string.squeeze_count, squeezeCount)
                }
        ...
        //this.lemonImage?.setImageResource(imageRes)
